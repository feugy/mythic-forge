...
requirejs.config  
  paths:
    ...
    'backbone-queryparams': '../vendor/backbone-queryparams-min',
    'hogan': '../vendor/hogan-2.0.0-min'
    'hotkeys': '../vendor/jquery-hotkeys-min'
    'html5slider': '../vendor/html5slider-min'
    'jquery': '../vendor/jquery-1.8.3-min'
    'jquery-ui': '../vendor/jquery-ui-1.9.2-min'
    'jquery-punch': '../vendor/jquery-punch-0.2.2-min'
    'i18n': '../vendor/i18n-2.0.1-min'
    'queryparser': '../vendor/queryparser-1.3.0-min'
    'md5': '../vendor/md5-2.2-min'
    'moment': '../vendor/moment-1.7.0-min'
